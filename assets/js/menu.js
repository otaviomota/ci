$(document).ready(function() {
	...
	posicao['sub0'] = new Array(	'-1px',		'-10px',	'-45px',	'-54px',	'-13px',			'-21px',		'-35px',		'-18px');
	posicao['sub1'] = new Array(	'-1px',		'-10px',	'-56px',	'-65px',	'-8px',				'-31px',		'-35px',		'-8px');
	//posicao['sub2'] = new Array(	'-1px',		'-10px',	'-38px',	'-47px',	'-8px',				'-7px',			'-45px',		'-8px');
	posicao['sub2'] = new Array(	'-1px',		'-10px',	'-45px',	'-54px',	'-8px',				'-7px',			'-45px',		'-15px');
	...
	posicao['menu_3'] = new Array(	'-1px',		'-0px',		'-39px',	'-48px',	'-8px',			'-15px',			'-35px',		'-10px',		'-17px',		'-28px');
